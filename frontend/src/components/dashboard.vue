<template>
  <v-container fluid>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>임시 저장 리스트</v-toolbar-title>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>작곡 완성 리스트</v-toolbar-title>
          <v-divider class="mx-4" inset vertical></v-divider>
          <v-dialog v-model="dialog" max-width="500px">
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "재생 길이", value: "initBalance" },
      { text: "생성 날짜", value: "currentBalance" },
      { text: "수정 날짜", value: "benefitRatio" },
